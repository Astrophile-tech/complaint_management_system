...
function SubmitComplaint() {
  ...
  const handleSubmit = event => {
    ...
    const complaintId = `E${Date.now()}`;
    
    const newComplaint = {id: complaintId,userId: currentUser.id,studentName: currentUser.name,...values,date: new Date().toLocaleDateString(), // Auto date
