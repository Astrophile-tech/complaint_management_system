...
function StatCard({ label, value, icon, color, sub }) {
  return (
    <Card sx={{ position: 'relative', overflow: 'hidden', height: '100%', borderRadius: 4, boxShadow: '0 4px 20px rgba(0,0,0,0.08)', transition: '0.3s', '&:hover':{transform:'translateY(-5px)', boxShadow:'0 8px 30px rgba(0,0,0,0.12)'} }}>
